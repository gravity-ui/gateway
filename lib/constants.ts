...
export const GatewayErrorCode = {
    ACTION_CALLBACK_REQUIRED: 'ACTION_CALLBACK_REQUIRED',
    ACTION_NOT_FOUND: 'ACTION_NOT_FOUND',
    EMPTY_GATEWAY_ENV: 'EMPTY_GATEWAY_ENV',
    EMPTY_GATEWAY_INSTALLATION: 'EMPTY_GATEWAY_INSTALLATION',
    ENDPOINT_NOT_FOUND: 'ENDPOINT_NOT_FOUND',
    GATEWAY_REQUEST_ERROR: 'GATEWAY_REQUEST_ERROR',
    GRPC_ACTION_NOT_FOUND: 'GRPC_ACTION_NOT_FOUND',
    INVALID_PARAMS: 'INVALID_PARAMS',
    INVALID_RESPONSE_CONTENT_TYPE: 'INVALID_RESPONSE_CONTENT_TYPE',
    REQUEST_WAS_CANCELLED: 'REQUEST_WAS_CANCELLED',
    SERVICE_NOT_FOUND: 'SERVICE_NOT_FOUND',
    UNKNOWN_SERVICE: 'UNKNOWN_SERVICE',
    UNKNOWN_SERVICE_ACTION: 'UNKNOWN_SERVICE_ACTION',
} as const;
